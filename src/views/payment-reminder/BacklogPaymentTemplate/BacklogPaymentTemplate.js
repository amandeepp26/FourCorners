...
const BacklogPaymentTemplate = ({ item }) => {
  ...
  <Box
    sx={{ 
      ...
      minWidth: 500,
      maxWidth: 700,
      borderRadius: 2, // Smooth corners for the modal box
    }}
  >
    <IconButton
      aria-label="cancel"
      ...
      sx={{
        ...
        top: 10,
        right: 10,
        backgroundColor: "#f5f5f5", // Subtle background color for the close button
        '&:hover': {
          backgroundColor: "#ffdddd", // On hover, make the background light red
        },
      }}
    >
    ...
    <Box
      ...
      sx={{
        display: "grid",
        gridTemplateColumns: "repeat(2, 1fr)", // Makes it more responsive (two columns)
    ...
    <Box sx={{ textAlign: "center", mt: 3 }}>
      <Button
        ...
        sx={{
          ...
          color: "#FFFFFF",
          padding: "10px 30px", // Better padding for button size
