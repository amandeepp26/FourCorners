  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (response.data.status === "Success") {
        ...
        setDataAvailable(true); // Set data available to true once data is successfully fetched
      } else {
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} md={6}>
                    <Box>
                      ...
                      <Typography variant="body2">Post: {totalReceived.cheque?.toLocaleString() || '0'}</Typography>
                      <Typography variant="body2">Loan: {totalReceived.loan?.toLocaleString() || '0'}</Typography>
                      <Typography variant="body2">Register: {totalReceived.register?.toLocaleString() || '0'}</Typography>
                  ...
                  <Grid item xs={12} md={6}>
                    <Box>
                      ...
                      <Typography variant="body2">Post: {totalUpcoming.cheque?.toLocaleString() || '0'}</Typography>
                      <Typography variant="body2">Loan: {totalUpcoming.loan?.toLocaleString() || '0'}</Typography>
                      <Typography variant="body2">Register: {totalUpcoming.register?.toLocaleString() || '0'}</Typography>
                      <Typography variant="body2" sx={{ mt: 1 }}>
                    ...
                    <TableBody>
                      {upcomingPaymentData.map((row) => (
                        <TableRow key={row.paymentID}>
                          ...
                          <TableCell>{row.AmountTypeName}</TableCell>
