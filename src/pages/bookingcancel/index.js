...
import SidebarBookingCancel from 'src/views/BookingCancel/SidebarBookingCancel';
import ProjectManage from 'src/views/addProject/ProjectManage';
import ListBookingCancel from 'src/views/BookingCancel/ListBookingCancel';
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12} md={4} style={{background:"white",zIndex:"99",display:"flex", flexWrap:"wrap"}}>
        <SidebarBookingCancel rows={rows} onItemClick={handleShow} onEdit={handleEdit} onCreate={handleAddTelecaller} />
      </Grid>
      <Grid item xs={8}>
