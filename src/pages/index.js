...
const Dashboard = ({ onHistoryClick }) => {
  ...
  const handleDownload = (type) => {
    ...
    if (!selectedData || selectedData.length === 0) {
      console.error(`No data available for ${type} download.`);
    ...
    if (type === "telecalling") {
      ...
      console.log("cvs  data 0", csvData);
      ...
      headers = [
        ...
        { label: "ParkingFacility", key: "ParkingFacility" },
        { label: "FlatCost", key: "FlatCost" },
        { label: "Gst", key: "Gst" },
        { label: "StampDuty", key: "StampDuty" },
        { label: "Registration", key: "Registration" },
        { label: "Advocate", key: "Advocate" },
        { label: "ExtraCost", key: "ExtraCost" },
        { label: "TotalValue", key: "TotalValue" },
        { label: "UsableArea", key: "UsableArea" },
        { label: "AgreementCarpet", key: "AgreementCarpet" },
        { label: "BookingRef", key: "BookingRef" },
        { label: "AggrementAmount", key: "AggrementAmount" },
        { label: "ProjectName", key: "ProjectName" },
        { label: "WingName", key: "WingName" },
        { label: "UnittypeName", key: "UnittypeName" },
        { label: "BookingTypeName", key: "BookingTypeName" },
                              ...
                              <TableCell>
                                {(() => {
                                  switch (selectedType) {
                                    ...
                                    case "todaysPayment":
                                      return (
                                        <Button onClick={() => fetchDataForModalPayment(row.BookingID)}>
